...
class CyVector2:
    ...
    @staticmethod
    def ones() -> 'CyVector2': ...
    def add(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def add_inplace(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def sub(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def sub_inplace(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def scale(self, scale: float) -> 'CyVector2': ...
    def scale_inplace(self, scale: float) -> 'CyVector2': ...
    def mul(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def mul_inplace(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def div(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def div_inplace(self, value: Union[float, 'CyVector2']) -> 'CyVector2': ...
    def get_length(self) -> float: ...
    def get_length_sqr(self) -> float: ...
    def get_dot_product(self, other: 'CyVector2') -> float: ...
