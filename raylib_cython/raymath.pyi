...
class CyVector4:
    ...
    def add(self, other: 'CyVector4') -> 'CyVector4': ...
    def add_inplace(self, other: 'CyVector4') -> 'CyVector4': ...
    def add_value(self, value: float) -> 'CyVector4': ...
    def add_value_inplace(self, value: float) -> 'CyVector4': ...
    def subtract(self, other: 'CyVector4') -> 'CyVector4': ...
    def subtract_inplace(self, other: 'CyVector4') -> 'CyVector4': ...
    def subtract_value(self, value: float) -> 'CyVector4': ...
    def subtract_value_inplace(self, value: float) -> 'CyVector4': ...
